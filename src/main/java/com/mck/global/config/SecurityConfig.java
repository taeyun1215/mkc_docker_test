...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/login/**", "/user/token/refresh", "/user/check-email-code**", "/user", "/post/**", "/user/username", "/user/password**", "/user/reset-password").permitAll();
        // 테스트용
...
//        http.addFilterBefore(new JwtExceptionFilter(), UsernamePasswordAuthenticationFilter.class);
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://www.devyeh.com"));
